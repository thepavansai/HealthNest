    ...
    <div className="terms-container">
      <div className="terms-content">
        ...
        <section className="terms-section">
          ...
          <p>
            We operate the website <a href="http://www.healthnest.com" className="terms-link">http://www.healthnest.com</a> (the "<strong>Site</strong>"), as well as any other related products and services that refer or link to these legal terms (the "<strong>Legal Terms</strong>") (collectively, the "<strong>Services</strong>").
          </p>
          <p>
