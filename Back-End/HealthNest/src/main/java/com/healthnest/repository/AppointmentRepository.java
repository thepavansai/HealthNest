...
public interface AppointmentRepository extends CrudRepository<Appointment, Long> {  // Changed from Integer to Long
    ...
    List<Appointment> findByUserUserId(Long userId);  // Changed from Integer to Long
    ...
    List<AppointmentShowDTO> findByDoctorIdWithUserName(@Param("doctorId") Long doctorId);  // Changed from Integer to Long
