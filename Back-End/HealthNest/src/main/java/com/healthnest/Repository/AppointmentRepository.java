...
public interface AppointmentRepository extends CrudRepository<Appointment, Integer> {
	...
	@Query("SELECT new com.healthnest.dto.AppointmentShowDTO(d.doctorName, u.name, u.phoneNo, a.appointmentStatus, a.description, a.appointmentDate, a.appointmentTime) " +
